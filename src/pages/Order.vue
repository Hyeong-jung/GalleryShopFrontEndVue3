        ...
        <div class="row g-5">
          <div class="col-md-5 col-lg-4 order-md-last">
            ...
            <h3 class="text-center total-price">
              {{lib.getNumberFormatted(computedPirce)}}원
            </h3>
          ...
          <div class="col-md-7 col-lg-8"><h4 class="mb-3">주문자 정보</h4>
            <div class="needs-validation" novalidate="">
              <div class="row g-3">
                <div class="col-12"><label for="username" class="form-label">주문자 이름</label>
                  <input type="text"
                         class="form-control"
                         id="username"
...
export default {
  ...
  setup() {
    ...
    return {state, lib, computedPirce, submit}
